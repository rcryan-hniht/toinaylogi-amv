...
export const TAG_JA_TO_VI: Record<string, string> = {
  ...
  長身: 'Dáng cao',
  高身長: 'Chiều cao nổi bật',
  低身長: 'Nấm lùn',
  小柄: 'Nhỏ nhắn',
  ミニ系: 'Vóc dáng nhỏ nhắn',
  ミニマム系: 'Nhỏ nhắn đáng yêu',
  スレンダー: 'Mảnh mai',
  清楚系スレンダー: 'Mảnh mai thanh thuần',
  ムッチリ: 'Đầy đặn',
  ややムチ: 'Hơi đẫy đà',
  ぽっちゃり: 'Chubby',
  ポチャ系美人: 'Mũm mĩm xinh xắn',
  クビレ: 'Eo thon',
  くびれ: 'Thắt đáy lưng ong',
  ダイナマイトボディ: 'Thân hình bốc lửa',
  マッスル: 'Cơ bắp quyến rũ',
  軟体: 'Cơ thể dẻo dai',
  色白: 'Làn da trắng nõn',
  美肌: 'Làn da mịn màng',
  美体: 'Dáng người tuyệt mỹ',

  // Vùng kín / Intimate features
  美マン: 'Vùng kín đẹp',
  デカビラ: 'Mép gợi cảm',
  ビラマン: 'Mép gợi cảm',
  名器: 'Cực phẩm danh khí',
  パイパン: 'Wax sạch bong',
  剛毛: 'Amazon tự nhiên',
  ...
  美顔: 'Cuti',
  美少女: 'Mỹ thiếu nữ',
  美少女系: 'Phong cách thiếu nữ',
  セクシー: 'Quyến rũ',
  セクシー系: 'Phong cách quyến rũ',
  可愛い: 'Dễ thương',
  かわいい: 'Đáng yêu',
  ...
  黒ギャル: 'Gyaru da nâu',
  ハーフ: 'Con lai',
  ショートカット: 'Tóc ngắn cá tính',
  ボーイッシュ: 'Tomboy cá tính',
  金髪: 'Tóc vàng',
  整形: 'Phẫu thuật thẩm mỹ',

  // Nghề nghiệp & Thân phận / Occupation & Background
  芸能人: 'Người nổi tiếng / Showbiz',
  芸人: 'Nghệ sĩ giải trí',
  元アイドル: 'Cựu thần tượng',
  元AKB48: 'Cựu thành viên AKB48',
  元女子アナ: 'Cựu MC truyền hình',
  グラドル: 'Người mẫu áo tắm',
  キャバ嬢: 'Hostess quán bar',
  キャバクラ嬢: 'Tiếp viên Cabaret',
  現役キャバ嬢: 'Tiếp viên quán bar đang làm',
  風俗嬢: 'Nhân viên ngành dịch vụ',
  デリヘル嬢: 'Gái gọi tận nơi',
  デリ嬢: 'Gái gọi',
  現役デリヘル嬢: 'Gái gọi đang hành nghề',
  ソープ嬢: 'Gái tắm Soapland',
  ホテヘル嬢: 'Gái dịch vụ khách sạn',
  セクシーパブ嬢: 'Nhân viên Sexy Pub',
  ストリッパー: 'Vũ nữ thoát y',
  アスリート: 'Vận động viên',
  柔道家: 'Võ sĩ Judo',
  OL: 'Nhân viên văn phòng',
  舞台女優: 'Diễn viên sân khấu',
  脚本家: 'Biên kịch',
  SOD女子社員: 'Nhân viên nữ SOD',
  恵比寿マスカッツ: 'Ebisu Muscats',
  アイドルヲタ: 'Fan cuồng idol',
  大河ドラマ: 'Từng đóng phim Taiga',

  // Thể loại & Trạng thái / Genre & Status
  名女優: 'Nữ diễn viên xuất sắc',
  専属: 'Diễn viên độc quyền',
  単体: 'Diễn viên độc quyền',
  企画: 'Diễn viên tự do',
  素人: 'Không chuyên / Nghiệp dư',
  伝説: 'Huyền thoại',
  引退: 'Đã giải nghệ',
  復活: 'Tái xuất',
  AV復活: 'Trở lại ngành AV',
  '改名・再移籍': 'Đổi nghệ danh / Chuyển công ty',
  流出: 'Lộ clip',
  無修正: 'Không che',
  潮吹き: 'Đài phun nước',
  レズ: 'Cắt kéo',
  レズビアン: 'Lesbian',
  アナル: 'Hậu môn',
  ぶっかけ: 'Bắn tinh lên mặt',
  ごっくん: 'Nuốt tinh trùng',
  SM: 'SM',
  着エロ: 'Trang phục gợi cảm',
  フィストファック: 'Fist fuck',
  カリビアン: 'Caribbeancom',
  一本道: '1pondo',
  heyzo: 'Heyzo',
  ...
  FC2: 'FC2',
  ガチん娘: 'Gachinko',
  人妻斬り: 'Chuyên trị gái có chồng',
  エッチな0930: '0930',
  エッチな4610: '4610',
  GirlsDelta: 'GirlsDelta',
  身バレ: 'Lộ danh tính',
  ニューハーフ: 'Người chuyển giới',
  男の娘: 'Femboy',
  タトゥー: 'Hình xăm',
  鼻ピアス: 'Khuyên mũi',
  両手両足タトゥー: 'Hình xăm tay chân',
  背面全面タトゥー: 'Hình xăm kín lưng',
  ほぼ全身タトゥー: 'Hình xăm toàn thân',
  '左右上腕＆左右大腿タトゥー': 'Hình xăm bắp tay đùi',
  黒人共演性交: 'Đóng cùng bạn diễn da màu',
  しろハメ: 'Nghiệp dư',
};
...
export const TAG_VI_TO_EN: Record<string, string> = {
  ...
  'Ngực siêu khủng gợi cảm': 'Sensual Huge Breasts',
  'Ngực đẹp': 'Beautiful Breasts',
  'Ngực khiêm tốn': 'Petite Breasts',
  'Ngực nhỏ xinh': 'Pretty Small Breasts',
  'Ngực lép': 'Flat Chest',
  ...
  'Nhũ hoa nhạy cảm': 'Sensitive Nipples',
  'Nhũ hoa thụt': 'Inverted Nipples',
  'Đầu ngực gợi cảm': 'Erotic Nipples',
  'Nhũ hoa nhô cao': 'Erect Nipples',
  'Nhũ hoa sẫm màu': 'Dark Nipples',
  'Nhũ hoa đẹp': 'Beautiful Nipples',
  ...
  'Nấm lùn': 'Petite',
  'Nhỏ nhắn': 'Small Stature',
  'Vóc dáng nhỏ nhắn': 'Petite Body',
  ...
  'Eo thon': 'Slim Waist',
  'Thắt đáy lưng ong': 'Hourglass Figure',
  'Thân hình bốc lửa': 'Dynamite Body',
  'Cơ bắp quyến rũ': 'Fit / Muscular',
  'Cơ thể dẻo dai': 'Flexible',
  ...
  'Người đẹp không tuổi': 'Ageless Beauty',
  ...
  'Con lai': 'Mixed / Half',
  'Tóc ngắn cá tính': 'Short Hair',
  'Tomboy cá tính': 'Boyish',
  'Tóc vàng': 'Blonde',
  'Phẫu thuật thẩm mỹ': 'Cosmetic Surgery',
  'Người nổi tiếng / Showbiz': 'Celebrity',
  'Nghệ sĩ giải trí': 'Entertainer',
  'Cựu thần tượng': 'Former Idol',
